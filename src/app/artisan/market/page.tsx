...
export default function MarketPage() {
  ...
  const mockB2B = [
    { title: "Corporate Diwali Hampers", qty: "500 Units", price: "â‚¹4,500/unit", buyer: "Tech Corp India" },
    { title: "Hotel Lobby Decor Sets", qty: "50 Units", price: "â‚¹12,000/set", buyer: "Taj Group" }
  ];
    ...
    <div className="min-h-screen bg-[var(--color-background)] font-sans pb-12">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="flex gap-2 sm:gap-4 mb-8 border-b border-gray-200 pb-1 overflow-x-auto no-scrollbar">
          ...
          >
            <Store size={18} /> My Storefront Listings
          </button>
          <button 
                        ...
                        <div key={item.id} className="bg-white rounded-2xl border border-green-200 shadow-sm overflow-hidden flex flex-col hover:shadow-md transition-all">
                          ...
                          <div className="p-5 flex flex-col flex-1">
                            ...
                            <div className="mt-auto pt-4 border-t border-gray-100 flex items-center justify-between">
                              <span className="text-[#0F2D20] font-bold text-lg">â‚¹{item.marketPriceMin || item.standardMarketPrice || 'N/A'}</span>
