    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center pb-20 font-sans selection:bg-primary/20">
      ...
      <div className="w-full bg-primary text-white py-8 px-4 flex flex-col items-center justify-center text-center shadow-md relative z-10">
        ...
        <p className="text-primary-light font-medium max-w-sm text-sm">
          This craft item is genuine and the artisan was paid fairly according to our algorithms.
        </p>
      </div>
      ...
      <div className="w-full max-w-md -mt-6 px-4 relative z-20 flex flex-col gap-6">
        ...
        <div className="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden flex flex-col animate-fade-in-up">
          ...
          <div className="p-6">
            ...
            <p className="text-sm text-primary font-bold mb-6 flex items-center gap-1">
              <MapPin size={14} /> {artisanProfile?.location || "Pochampally Weavers Cooperative"}
            </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-1">
                ...
                <span className="font-medium text-gray-900">₹{item.rawMaterialCost || 2800}</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-md border border-gray-100 p-6 animate-fade-in-up flex flex-col items-center text-center">
        ...
        <div className="bg-white rounded-3xl shadow-md border border-gray-100 p-6 animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl p-3 flex items-start gap-3">
              ...
              <p className="text-sm text-green-800 leading-tight">
                This artisan received an immediate fair wage advance, ensuring ethical compensation for their craft before it even sells.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-md border border-gray-100 p-6 animate-fade-in-up" style={{ animationDelay: '0.15s' }}>
          <h3 className="font-bold text-lg text-gray-900 mb-4 flex items-center gap-2">
        ...
        <VerificationCamera patchId={currentPatchId} />

        {/* Audit Log Timeline Block */}
        <div className="bg-white rounded-3xl shadow-md border border-gray-100 p-6 animate-fade-in-up mt-6" style={{ animationDelay: '0.2s' }}>
